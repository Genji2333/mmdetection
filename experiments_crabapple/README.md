...
# 跑完
tmux attach -t openmmlab
点击pear-new标签查看是否结束
结束后，打开compare.ipynb，选择openmmlab环境，把所有的跑一遍，会在log目录下生成summary.txt，里面记录了coco指标。
coco/bbox_mAP_max，看max即可，不用看mean和min
以下是coco指标，和yolo指标不一样，更详细的可以问问郭彤或者王艺群。
![Alt text](1756869643004.png)
