...
# CUDA_VISIBLE_DEVICES=4,5 PORT=7878 ./tools/dist_train.sh experiments/dynamic_rcnn/dynamic-rcnn_r50_fpn_1x_coco.py 2 --work-dir ./log/dynamic_rcnn ; 
# echo "****************************************" ;  

# CUDA_VISIBLE_DEVICES=4,5 PORT=7878 ./tools/dist_train.sh experiments/libra_rcnn/libra-faster-rcnn_r50_fpn_1x_coco.py 2 --work-dir ./log/libra_rcnn ; 
# echo "****************************************" ; 

# CUDA_VISIBLE_DEVICES=4,5 PORT=7878 ./tools/dist_train.sh experiments/detr/detr_r50_8xb2-150e_coco.py 2 --work-dir ./log/detr ; 
# echo "****************************************" ;  

# CUDA_VISIBLE_DEVICES=4,5 PORT=7878 ./tools/dist_train.sh experiments/CO-DETR/co_dino_5scale_r50_lsj_8xb2_1x_coco.py 2 --work-dir ./log/CO-DETR ; 
# echo "****************************************" ;  
